      ...
      if (
        ...
        if (thisElement.parentNode.previousElementSibling) {
          ...
          if (previousItem.querySelector('.sub-menu')) {
            ...
            previousItem.querySelector('.dropdown-toggle').setAttribute('aria-label', `${Air_Frost_screenReaderText.expand_for} ${previousItem.querySelector('.dropdown-item').innerText}`);
    ...
    addMultipleEventListeners(item, ['click', 'keydown', 'keypress'], (e) => {
      ...
      if (e.key === 'Enter' || e.type === 'click') {
        ...
        if (thisElement.getAttribute('aria-expanded') === 'false') {
          ...
          // eslint-disable-next-line camelcase, no-undef
          thisElement.setAttribute('aria-label', `${Air_Frost_screenReaderText.collapse_for} ${linkLabel}`);
        } else {
          ...
          // Set aria-label of the dropdown button
          // eslint-disable-next-line camelcase, no-undef
          thisElement.setAttribute('aria-label', `${Air_Frost_screenReaderText.expand_for} ${linkLabel}`);
        }
      ...
      if (e.key === 'Escape') {
        ...
        // eslint-disable-next-line camelcase, no-undef
        dropdownToggleButton.setAttribute('aria-label', `${Air_Frost_screenReaderText.expand_for} ${linkLabel}`);
