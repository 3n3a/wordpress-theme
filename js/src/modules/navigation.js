 ...
 * The original, accessible navigation module for air-frost
 */
...
const navMobile = () => {
  ...
  function navToggle(e) {
    ...
    if (e.type === 'click' || e.keyCode === 13) {
      ...
      if (document.getElementById('nav-toggle').getAttribute('aria-label') === Air_Frost_screenReaderText.expand_toggle) {
        // eslint-disable-next-line camelcase, no-undef
        document.getElementById('nav-toggle').setAttribute('aria-label', Air_Frost_screenReaderText.collapse_toggle);
      } else {
        // eslint-disable-next-line camelcase, no-undef
        document.getElementById('nav-toggle').setAttribute('aria-label', Air_Frost_screenReaderText.expand_toggle);
      }
